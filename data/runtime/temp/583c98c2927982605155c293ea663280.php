...
<div class="wrap " style="padding:10px;">
    ...
    <div class="tabbable">
        <div class="tab-content ">
            <div class="tab-pane <?php echo $tab=='local' ? 'active' : ''; ?>" id="wrapper">
            ...
            <div class="tab-pane <?php echo $tab=='url' ? 'active' : ''; ?>" id="B">
