...
<style>
    ...
    <link href="/themes/simpleboot3_mobile/public/assets/css/service.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="content">
    <?php if(is_array($about_site['create']) || $about_site['create'] instanceof \think\Collection || $about_site['create'] instanceof \think\Paginator): if( count($about_site['create'])==0 ) : echo "" ;else: foreach($about_site['create'] as $key=>$vo): ?>
        <div class="service-content clearfix">
                <div class="service-content-left">
                    <div class="service-content-title">
                        <?php echo $vo['create_name']; ?>
                    </div>
                    <div class="service-content-text">
                        <?php echo htmlspecialchars_decode($vo['create_desc']); ?>
                    </div>
                </div>
                <div class="service-content-right">
                    <img loading="lazy" src="<?php echo cmf_get_image_url($vo['create_image']); ?>"
                         alt="<?php echo $vo['create_name']; ?>">
                </div>
        </div>
    <?php endforeach; endif; else: echo "" ;endif; ?>
