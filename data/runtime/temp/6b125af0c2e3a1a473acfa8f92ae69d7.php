...
<style>
    ...
    <link href="/themes/simpleboot3_mobile/public/assets/css/about.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.css" />
    <script src="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.umd.js"></script>
    <script type="text/javascript" src="/themes/simpleboot3_mobile/public/assets/js/about.js"></script>
</head>
<body>
    ...
    <ul class="certificate-list">
        <?php if(is_array($about_site['cert']) || $about_site['cert'] instanceof \think\Collection || $about_site['cert'] instanceof \think\Paginator): if( count($about_site['cert'])==0 ) : echo "" ;else: foreach($about_site['cert'] as $key=>$vo): ?>
            <li class="certificate-item">
                <a href="<?php echo cmf_get_image_url($vo['url']); ?>" data-fancybox="gallery" data-caption="<?php echo $vo['name']; ?>">
