...
<div class="content">
    <div class="title">GLOBAL SERVICE</div>

    <div class="service-desc"><?php echo $service_site['internationalization']; ?></div>

    <div class="service-img">
        <img src="<?php echo cmf_get_image_url($service_site['internationalization_image']); ?>">
    </div>

    <ul class="service-area">
        <?php if(is_array($service_site['areas']) || $service_site['areas'] instanceof \think\Collection || $service_site['areas'] instanceof \think\Paginator): if( count($service_site['areas'])==0 ) : echo "" ;else: foreach($service_site['areas'] as $key=>$vo): ?>
            <li class="service-area-item" style="background-color: <?php echo $vo['color']; ?>">
                <div class="service-area-title"><?php echo $vo['area']; ?></div>
                <div class="service-area-line"></div>
                <div class="service-area-country">(<?php echo $vo['country']; ?> Country)</div>
            </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    ...
    <div class="service-intro">
        <div class="service-intro-item">
            <div class="service-intro-title"><?php echo $service_site['left_title']; ?></div>
            <div class="service-intro-desc"><?php echo $service_site['left_desc']; ?></div>
        </div>
        <div class="service-intro-item">
            <div class="service-intro-title"><?php echo $service_site['left_title']; ?></div>
            <div class="service-intro-desc"><?php echo $service_site['left_desc']; ?></div>
    ...
    <div class="service-partner">
        <div class="title">Companies that have established cooperation</div>
