...
<style>
    ...
    <link href="/themes/simpleboot3/public/assets/css/service.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<style>
    /* Make the banner automatically scale based on the original image ratio so it displays completely without cropping */
    .banner {
    ...
    /* Cool Hover Effects for Modules */
    .hover-module-item {
    ...
    .hover-module-item:hover {
        transform: translateY(-12px);
        box-shadow: 0 20px 40px rgba(203, 42, 41, 0.15);
    }
    .hover-module-item .img-wrap {
        overflow: hidden;
        flex-grow: 1;
    }
    .hover-module-item .img-wrap img {
        transition: transform 0.6s ease;
        display: block;
    }
    .hover-module-item:hover .img-wrap img {
        transform: scale(1.1);
    }
    .hover-module-item .title-text {
        transition: color 0.3s ease;
    }
    .hover-module-item:hover .title-text {
        color: #cb2a29 !important;
    }
    .packaging-section .hover-module-item, .support-section .hover-module-item {
        padding-bottom: 20px;
    }

    /* Cooperation Process Icon Redesign */
    .coop-icon-wrap {
        width: 76px;
        height: 76px;
        ...
        position: relative;
        z-index: 2;
        box-shadow: 0 8px 25px rgba(203, 42, 41, 0.15);
        transition: all 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);
    }
    .coop-icon-wrap::before {
        content: '';
        position: absolute;
        top: -6px;
        left: -6px;
        right: -6px;
        bottom: -6px;
        border: 2px dashed rgba(203, 42, 41, 0.2);
        border-radius: 50%;
    ...
    .hover-module-item:hover .coop-icon-wrap {
        background: #cb2a29;
        box-shadow: 0 12px 30px rgba(203, 42, 41, 0.3);
    }
    .hover-module-item:hover .coop-icon-wrap::before {
        top: -2px;
        left: -2px;
        right: -2px;
        bottom: -2px;
        border-style: solid;
        border-color: rgba(203, 42, 41, 0.8);
        animation-play-state: paused;
    }
    .hover-module-item:hover .coop-icon-wrap i {
        color: #fff !important;
        transform: scale(1.1) rotate(y);
    }
    .coop-icon-wrap i {
        font-size: 32px;
        color: #cb2a29;
    ...
    .card-text { font-size: 16px !important; line-height: 1.6; }
    .title-text { font-size: 25px !important; }
</style>

<div class="service-cards-section reveal">
...
<?php if(!(empty($service_site['packaging_items']) || (($service_site['packaging_items'] instanceof \think\Collection || $service_site['packaging_items'] instanceof \think\Paginator ) && $service_site['packaging_items']->isEmpty()))): ?>
<div class="packaging-section" style="max-width: 1400px; width: 94%; margin: 60px auto;">
    <h2 style="text-align: center; font-size: 32px; font-weight: bold; color: #333; margin-bottom: 40px;">
        <?php echo (isset($service_site['packaging_title']) && ($service_site['packaging_title'] !== '')?$service_site['packaging_title']:'Packaging & Shipping'); ?>
    </h2>
    <div style="display: flex; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
        <?php if(is_array($service_site['packaging_items']) || $service_site['packaging_items'] instanceof \think\Collection || $service_site['packaging_items'] instanceof \think\Paginator): if( count($service_site['packaging_items'])==0 ) : echo "" ;else: foreach($service_site['packaging_items'] as $key=>$vo): ?>
            <div style="flex: 1; min-width: 200px; text-align: center;">
                <div class="hover-module-item">
                    <div class="img-wrap" style="margin-bottom: 15px;">
                        <img src="<?php echo cmf_get_image_url($vo['img']); ?>" alt="<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>" style="width: 100%; aspect-ratio: 4/3; object-fit: cover;">
                    </div>
                    <div class="title-text" style="font-size: 28px; font-weight: bold; color: #333;"><?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?></div>
                </div>
            </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
<?php endif; if(!(empty($service_site['cooperation_items']) || (($service_site['cooperation_items'] instanceof \think\Collection || $service_site['cooperation_items'] instanceof \think\Paginator ) && $service_site['cooperation_items']->isEmpty()))): ?>
<div class="cooperation-section" style="max-width: 1400px; width: 94%; margin: 60px auto;">
    <h2 style="text-align: center; font-size: 32px; font-weight: bold; color: #333; margin-bottom: 40px;">
        <?php echo (isset($service_site['cooperation_title']) && ($service_site['cooperation_title'] !== '')?$service_site['cooperation_title']:'Cooperation Process'); ?>
    </h2>
    <div style="display: flex; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
        <?php if(is_array($service_site['cooperation_items']) || $service_site['cooperation_items'] instanceof \think\Collection || $service_site['cooperation_items'] instanceof \think\Paginator): if( count($service_site['cooperation_items'])==0 ) : echo "" ;else: foreach($service_site['cooperation_items'] as $k=>$vo): ?>
            <div style="flex: 1; min-width: 200px; padding-top: 38px;">
                <div class="hover-module-item" style="background: #fafafa; overflow: visible;">
                    <div style="text-align: center; padding: 0 20px 25px; position: relative; z-index: 2; background: transparent;">
                        <div class="coop-icon-wrap">
                            <i class="<?php echo (isset($vo['icon']) && ($vo['icon'] !== '')?$vo['icon']:''); ?>" style="position: relative; z-index: 3;"></i>
                        </div>
                        <div class="title-text" style="font-size: 28px; font-weight: bold; color: #333;">
                            <?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>
                        </div>
                    </div>
                    <div class="img-wrap" style="border-radius: 0 0 12px 12px; overflow: hidden;">
                        <img src="<?php echo cmf_get_image_url($vo['img']); ?>" alt="<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>" style="width: 100%; aspect-ratio: 16/9; object-fit: cover;">
                    </div>
                </div>
            </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<?php endif; if(!(empty($service_site['support_items']) || (($service_site['support_items'] instanceof \think\Collection || $service_site['support_items'] instanceof \think\Paginator ) && $service_site['support_items']->isEmpty()))): ?>
<div class="support-section" style="max-width: 1400px; width: 94%; margin: 60px auto;">
    <h2 style="text-align: center; font-size: 32px; font-weight: bold; color: #333; margin-bottom: 40px;">
        <?php echo (isset($service_site['support_title']) && ($service_site['support_title'] !== '')?$service_site['support_title']:'Technical Support'); ?>
    </h2>
    <div style="display: flex; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
        <?php if(is_array($service_site['support_items']) || $service_site['support_items'] instanceof \think\Collection || $service_site['support_items'] instanceof \think\Paginator): if( count($service_site['support_items'])==0 ) : echo "" ;else: foreach($service_site['support_items'] as $key=>$vo): ?>
            <div style="flex: 1; min-width: 200px; text-align: center;">
                <div class="hover-module-item">
                    <div class="img-wrap" style="margin-bottom: 15px;">
                        <img src="<?php echo cmf_get_image_url($vo['img']); ?>" alt="<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>" style="width: 100%; aspect-ratio: 16/9; object-fit: cover;">
...
<?php endif; if(!(empty($service_site['aftersales_img_left']) || (($service_site['aftersales_img_left'] instanceof \think\Collection || $service_site['aftersales_img_left'] instanceof \think\Paginator ) && $service_site['aftersales_img_left']->isEmpty()))): ?>
<div class="aftersales-section" style="max-width: 1400px; width: 94%; margin: 60px auto;">
    <h2 style="text-align: center; font-size: 32px; font-weight: bold; color: #333; margin-bottom: 40px;">
        <?php echo (isset($service_site['aftersales_title']) && ($service_site['aftersales_title'] !== '')?$service_site['aftersales_title']:'After-sales Service'); ?>
    </h2>
    <div style="display: flex; gap: 20px;">
        <!-- Left Column -->
        <div style="flex: 1;" class="hover-module-item">
            <div class="img-wrap" style="height: 100%;">
                <img src="<?php echo cmf_get_image_url($service_site['aftersales_img_left']); ?>" alt="After-sales Left" style="width: 100%; height: 100%; object-fit: cover; min-height: 400px;">
            </div>
        </div>
        ...
        <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
            <!-- Top -->
            <div class="hover-module-item" style="flex: 1; position: relative;">
                <div class="img-wrap" style="height: 100%; position: absolute; inset: 0;">
                    <img src="<?php echo cmf_get_image_url($service_site['aftersales_img_mt']); ?>" alt="<?php echo (isset($service_site['aftersales_text_mt']) && ($service_site['aftersales_text_mt'] !== '')?$service_site['aftersales_text_mt']:''); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
                <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 60%; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); pointer-events: none; z-index: 1;"></div>
                <div style="position: absolute; bottom: 20px; left: 20px; color: #fff; font-size: 28px; font-weight: bold; z-index: 10;">
                    <?php echo (isset($service_site['aftersales_text_mt']) && ($service_site['aftersales_text_mt'] !== '')?$service_site['aftersales_text_mt']:''); ?>
                </div>
            </div>
            <!-- Bottom -->
            <div class="hover-module-item" style="flex: 1; position: relative; min-height: 200px;">
                <div class="img-wrap" style="height: 100%; position: absolute; inset: 0;">
                    <img src="<?php echo cmf_get_image_url($service_site['aftersales_img_mb']); ?>" alt="<?php echo (isset($service_site['aftersales_text_mb']) && ($service_site['aftersales_text_mb'] !== '')?$service_site['aftersales_text_mb']:''); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
                <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 60%; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); pointer-events: none; z-index: 1;"></div>
                <div style="position: absolute; bottom: 20px; left: 20px; color: #fff; font-size: 28px; font-weight: bold; z-index: 10;">
                    <?php echo (isset($service_site['aftersales_text_mb']) && ($service_site['aftersales_text_mb'] !== '')?$service_site['aftersales_text_mb']:''); ?>
                </div>
            </div>
        </div>
        ...
        <!-- Right Column -->
        <div style="flex: 1;" class="hover-module-item">
            <div class="img-wrap" style="height: 100%; border: 1px solid #eaeaea;">
                <img src="<?php echo cmf_get_image_url($service_site['aftersales_img_right']); ?>" alt="After-sales Certificate" style="width: 100%; height: 100%; object-fit: cover; min-height: 400px; padding: 10px;">
            </div>
        </div>
    </div>
</div>
...
<div class="content" style="padding-top: 0;">
    ...
    <div class="download-section" style="max-width: 1400px; width: 94%; margin: 60px auto;">
        <h2 style="text-align: center; font-size: 32px; font-weight: bold; color: #333; margin-bottom: 40px;">
            Product Brochures
        </h2>
        <ul class="download-list">
            <?php if(is_array($download_list) || $download_list instanceof \think\Collection || $download_list instanceof \think\Paginator): if( count($download_list)==0 ) : echo "" ;else: foreach($download_list as $key=>$vo): ?>
                <li class="download-item">
                    <a href="<?php echo cmf_get_image_preview_url($vo['more']['file']['url']); ?>" target="_blank" download>
                        ...
                        <div class="download-item-bottom">
                            <div class="download-item-bottom-left">
                                <img src="/themes/simpleboot3/public/assets/images/pdf.png" alt="pdf">
                                Download PDF
                            </div>
                            <div class="download-item-bottom-right">
                                <img src="/themes/simpleboot3/public/assets/images/download.png" alt="download">
                            </div>
                        </div>
                    </a>
                </li>
    ...
    <div class="service-partner">
        <div class="title" style="font-size: 32px; font-weight: bold; color: #333; text-align: center; margin-bottom: 40px;">Companies that have established cooperation</div>
