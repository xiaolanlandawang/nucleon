...
<style>
    ...
    <link href="/themes/simpleboot3_mobile/public/assets/css/news.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="content clearfix">
    <div class="mobile-breadcrumb" style="margin: 1.6rem 0 1.6rem 0; width: 100%;">
        <a href="/">Home</a>
        <span>/</span>
        <span>News</span>
    </div>
    ...
    <div class="category-list">
        <ul>
            <?php if(is_array($news_category) || $news_category instanceof \think\Collection || $news_category instanceof \think\Paginator): if( count($news_category)==0 ) : echo "" ;else: foreach($news_category as $key=>$vo): ?>
                <li class="category-item <?php echo input('id')==$vo['id'] ? 'active' : ''; ?>" onclick="location.href='<?php echo cmf_url("portal/index/news",array("id"=>$vo["id"])); ?>'">
                <?php echo $vo['name']; ?>
                </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    ...
    <div class="products-list">
        <ul class="clearfix">
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <li onclick="location.href='<?php echo cmf_url("portal/index/news_info",array("cid"=>$vo["cid"],"id"=>$vo["id"])); ?>'">
                <div class="item-img">
                    <img src="<?php echo cmf_get_image_url($vo['thumbnail']); ?>" alt="<?php echo $vo['post_title']; ?>">
                </div>
                <div class="item-content">
                    <div class="item-time">
                        <span class="item-time-day"><?php echo date('d',$vo['create_time']); ?></span>/<?php echo date('Y-m',$vo['create_time']); ?>
                    </div>
                    <div class="item-title"><?php echo $vo['post_title']; ?></div>
                    <div class="item-desc"><?php echo $vo['post_excerpt']; ?></div>
                </div>
                </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
