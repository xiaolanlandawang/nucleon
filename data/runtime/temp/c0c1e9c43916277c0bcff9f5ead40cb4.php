<?php /*a:2:{s:79:"C:\laragon\www\nucleon\public/themes/admin_simpleboot3/admin\message\index.html";i:1778145407;s:73:"C:\laragon\www\nucleon\public/themes/admin_simpleboot3/public\header.html";i:1730268636;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('Message/index'); ?>">留言列表</a></li>
        <li><a href="<?php echo url('Message/deletedList'); ?>">已删除列表</a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('Message/index'); ?>">
        时间:
        ...
        <a class="btn btn-danger" href="<?php echo url('Message/index'); ?>">清空</a>
    </form>
    <form class="js-ajax-form" action="" method="post">
        <button class="btn btn-danger btn-sm js-ajax-submit" type="submit"
                data-action="<?php echo url('Message/delete'); ?>" data-subcheck="true" data-msg="您确定删除吗？">删除
        </button>
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-primary" href="javascript:;"
                           onclick="openPortalArticleEditDialog(this)"
                           data-href="<?php echo url('Message/user_access_log',array('id'=>$vo['id'])); ?>">查看</a>
                    </td>
