<?php /*a:1:{s:72:"C:\laragon\www\nucleon\public/themes/admin_simpleboot3/admin\\login.html";i:1774746171;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <h1 class="text-center"><img src="/themes/admin_simpleboot3/public/assets/images/logo.svg"></h1>
                <form class="js-ajax-form" action="<?php echo url('public/doLogin'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <div style="position: relative;">
                            <input type="text" name="captcha" placeholder="<?php echo lang('Captcha'); ?>" class="form-control captcha">
...
<script src="/themes/admin_simpleboot3/public/assets/js/jquery-1.10.2.min.js?v=<?php echo $_static_version; ?>"></script>
