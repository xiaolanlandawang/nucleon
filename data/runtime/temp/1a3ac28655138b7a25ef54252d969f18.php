...
<style>
    ...
    <link href="/themes/simpleboot3_mobile/public/assets/css/quote.css" rel="stylesheet" type="text/css">
</head>
    ...
    <div class="main-content">
        <div class="contact">
            <div class="contact-left">
                <div class="contact-left-title"><?php echo $site_info['site_name']; ?></div>
                <div class="contact-left-content">
                    <img src="/themes/simpleboot3_mobile/public/assets/images/quote-email.webp" alt="email">
                    <a>
                        <p><?php echo (isset($site_info['email']) && ($site_info['email'] !== '')?$site_info['email']:''); ?></p>
                    </a>
                </div>
                <div class="contact-left-content">
                    <img src="/themes/simpleboot3_mobile/public/assets/images/quote-location.webp" alt="location">
                    <a>
                        <p><?php echo (isset($site_info['address']) && ($site_info['address'] !== '')?$site_info['address']:''); ?></p>
                    </a>
                </div>
                <div class="contact-left-content">
                    <img src="/themes/simpleboot3_mobile/public/assets/images/quote-whatsapp.webp" alt="whatsapp">
                    <a>
                        <p><?php echo (isset($site_info['whatsapp']) && ($site_info['whatsapp'] !== '')?$site_info['whatsapp']:''); ?></p>
                    </a>
                </div>
                <div class="contact-left-content">
                    <img src="/themes/simpleboot3_mobile/public/assets/images/quote-tel.webp" alt="tel">
                    <a>
                        <p><?php echo (isset($site_info['sale_tel']) && ($site_info['sale_tel'] !== '')?$site_info['sale_tel']:''); ?></p>
                    </a>
                </div>
                <div class="contact-left-content">
                    <img src="/themes/simpleboot3_mobile/public/assets/images/quote-time.webp" alt="time">
                    <a>
                        <p>0:00-24:00</p>
                    </a>
                </div>
...
<?php endif; ?>
    ...
    <script>
        function submit() {
            ...
            let phone = getFormattedPhoneNumber($('.quote-phone'));// 手机号
