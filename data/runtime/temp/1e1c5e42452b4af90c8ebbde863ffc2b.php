<?php /*a:1:{s:77:"C:\laragon\www\nucleon\public/themes/admin_simpleboot3/admin\index\index.html";i:1774746248;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title><?php echo lang('ADMIN_CENTER'); ?></title>
...
<?php $is_mobile=cmf_is_mobile(); ?>
<body style="min-width:<?php echo !empty($is_mobile) ? 'auto' : '900px'; ?>;overflow: hidden;">
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/Index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;display: flex;justify-content: center;">
                <img src="/themes/admin_simpleboot3/public/assets/images/logo-white.svg">
            </a>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="/themes/admin_simpleboot3/public/assets/images/logo-18.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
                        ...
                        <?php if(cmf_auth_check(cmf_get_current_admin_id(),'admin/Setting/site')): ?>
                            <li>
                                <a href="javascript:openapp('<?php echo url('Setting/site'); ?>','index_site','<?php echo lang('ADMIN_SETTING_SITE'); ?>');"><i
                                        class="fa fa-cog fa-fw"></i> <?php echo lang('ADMIN_SETTING_SITE'); ?></a></li>
                        <?php endif; if(cmf_auth_check(cmf_get_current_admin_id(),'admin/user/userinfo')): ?>
                            <li>
                                <a href="javascript:openapp('<?php echo url('User/userinfo'); ?>','index_userinfo','<?php echo lang('ADMIN_USER_USERINFO'); ?>');"><i
                                        class="fa fa-user fa-fw"></i> <?php echo lang('ADMIN_USER_USERINFO'); ?></a></li>
                        <?php endif; if(cmf_auth_check(cmf_get_current_admin_id(),'admin/Setting/password')): ?>
                            <li>
                                <a href="javascript:openapp('<?php echo url('Setting/password'); ?>','index_password','<?php echo lang('ADMIN_SETTING_PASSWORD'); ?>');"><i
                                        class="fa fa-lock fa-fw"></i> <?php echo lang('ADMIN_SETTING_PASSWORD'); ?></a></li>
                        <?php endif; ?>
                        <li><a href="<?php echo url('Public/logout'); ?>"><i class="fa fa-sign-out fa-fw"></i> <?php echo lang('LOGOUT'); ?></a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<div class="main-container container-fluid">
        ...
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            ...
            <?php if(cmf_auth_check(cmf_get_current_admin_id(),'user/AdminAsset/index')): ?>
                <a class="btn btn-sm btn-info"
                   href="javascript:openapp('<?php echo url('user/AdminAsset/index'); ?>','userAdminAssetindex','<?php echo lang('USER_ADMINASSET_INDEX'); ?>',true);"
                   title="<?php echo lang('USER_ADMINASSET_INDEX'); ?>"
                   data-toggle="tooltip">
            ...
            <?php endif; if(cmf_auth_check(cmf_get_current_admin_id(),'admin/RecycleBin/index')): ?>
                <a class="btn btn-sm btn-danger"
                   href="javascript:openapp('<?php echo url('admin/RecycleBin/index'); ?>','index_recycle','<?php echo lang('ADMIN_RECYCLEBIN_INDEX'); ?>',true);"
                   title="<?php echo lang('ADMIN_RECYCLEBIN_INDEX'); ?>"
                   data-toggle="tooltip">
            ...
            <a class="btn btn-sm btn-default"
               id="dev-menu-button"
               style="display: <?php echo $dev_menu_display; ?>;"
               href="javascript:openapp('<?php echo url('admin/Dev/index'); ?>','index_dev','开发面板',true);"
               title="开发面板"
               data-toggle="tooltip">
    ...
    <div class="main-content">
        <div class="page-content" id="content">
            <iframe src="<?php echo url('setting/site'); ?>" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0"
...
<script src="/themes/admin_simpleboot3/public/assets/simpleboot3/js/adminindex.js?v=<?php echo $_static_version; ?>"></script>
<script>
    Wind.css('artDialog');
    $(function () {
    ...
    function openDevTips() {
        ...
        if (openDevTipsTimes < 20) {
            console.log('打开开发者面板,请执行:')
            console.log("$('#dev-menu-button').show();openapp('/admin/dev/index.html','index_dev','开发面板',true);");
        } else {
