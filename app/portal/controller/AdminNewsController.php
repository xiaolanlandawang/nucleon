...
class AdminNewsController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $data        = $postService->adminArticleList($param,8);

        $data->appends($param);

        $portalCategoryModel = new PortalCategoryModel();
        $categoryTree        = $portalCategoryModel->adminCategoryTree(8, $categoryId);
    ...
    public function edit()
    {
        ...
        $routeModel         = new RouteModel();
        $alias              = $routeModel->getUrl('portal/index/news_info', ['id' => $id,'cid'=>$postCategoryIds]);
